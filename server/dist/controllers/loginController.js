...
loginController.getAllUsers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
//create user
loginController.createUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
loginController.verifyUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { username, password } = req.body;
    try {
